                        ...
                        <el-table-column  label="状态">
                            <template slot-scope="scope">
                                <div slot="reference" class="name-wrapper">
                                    <el-tag size="medium" v-if="scope.row.type1 == '已读'" type="success">{{ scope.row.type1 }}</el-tag>
                                    <el-tag size="medium" v-else="scope.row.type1 == '未读'">{{ scope.row.type1 }}</el-tag>
                                </div>
                            </template>
                        </el-table-column>
                        <el-table-column
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <el-button
                                        ...
                                        type="success"
                                        plain
                                        @click="readY(scope.$index, scope.row)">已读</el-button>
                                <el-button
                                        size="mini"
                                        type="info"
                                        plain
                                        @click="readN(scope.$index, scope.row)">未读</el-button>
                            </template>
                        </el-table-column>
                    </el-table>
