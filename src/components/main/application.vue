                ...
                <el-card style="margin-top:20px ;margin-bottom: 5rem">
                    <el-table
                        ...
                        <el-table-column
                                label="申请时间"
                                sortable>
                            <template slot-scope="scope">{{ scope.row.createtime | date}}
                        ...
                        <el-table-column
                            ...
                            <template slot-scope="scope">
                                <el-tag :type="scope.row.state == 0 ? 'info' : (scope.row.state == 1 ? 'danger' : 'success')">
