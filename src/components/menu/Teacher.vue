    ...
    <div class="common">
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <router-link tag="a" to="/teacher/home" class="nav-link" style="font-size:15px">回到主界面</router-link>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a to="/admin/home" class="brand-link">
                <span v-text="type" class="brand-text font-weight-light" style="margin-left: 5%"></span>
            </a>
